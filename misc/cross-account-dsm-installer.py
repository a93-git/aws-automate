""" A script to install Trend Micro DSM agent on the Windows and Linux EC2 instances (matching a given pair of Tag key and value) in AWS environment
...
Script_Url_Linux - URL for script for installation on Linux
Script_Url_Windows - URL for script for installation on Windows
